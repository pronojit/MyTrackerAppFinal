...
public class MainActivity extends AppCompatActivity {
    ...
    private void initPubnub() {
        ...
        pnConfiguration.setSubscribeKey(Constants.PUBNUB_SUBSCRIBE_KEY2);
        pnConfiguration.setPublishKey(Constants.PUBNUB_PUBLISH_KEY2);
        pnConfiguration.setSubscribeKey(Constants.PUBNUB_SUBSCRIBE_KEY3);
        pnConfiguration.setPublishKey(Constants.PUBNUB_PUBLISH_KEY3);
